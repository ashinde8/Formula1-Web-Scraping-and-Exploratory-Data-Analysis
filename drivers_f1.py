...
def run(year1,year2):
    ...
    for i in range(year1, year2 + 1):
        ...
        file_yr = str(i)
        file_name = file_yr + 'driver_standings_table.txt'
        ...
        for tr in table_rows:
            ...
            dvr_tags = tr.find('span',{'class':'hide-for-mobile'})
            driver_name = dvr_tags.text.strip()
            ...
            constructor_tags = tr.find('a',{'href': re.compile('/en/results.html/' + file_yr + '/team/')})
